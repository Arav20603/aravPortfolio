...
const Footer = () => {
  return (<footer className="mt-24 bg-black/80 backdrop-blur-xl border-t border-blue-900 text-blue-100"> <div className="max-w-7xl mx-auto px-6 py-16">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-14">
      ...
      <div className="flex flex-col gap-5">
        ...
        <p className="text-sm text-blue-300 leading-relaxed max-w-sm">
          ...
          Full-Stack Development, Mobile Applications, and
          Software Engineering.
        </p>

        <div className="w-10 h-px bg-blue-500/50" />

        <div className="text-sm text-blue-400 space-y-3">

          <div className="flex items-center gap-3">
            <MapPin size={16} color="#DC143C" />
            <span>Bengaluru, India</span>
          </div>

          <a
            href="mailto:dakshandaravind@gmail.com"
            className="flex items-center gap-3 hover:text-blue-300 transition"
          >
            <Mail size={16} color="#DC143C" />
            <span>dakshandaravind@gmail.com</span>
          </a>

          <a
            href="tel:+918088276220"
            className="flex items-center gap-3 hover:text-blue-300 transition"
          >
            <Phone size={16} color="#DC143C" />
            <span>+91 80882 76220</span>
          </a>
    ...
    <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-blue-400">
      <p>
        © {new Date().getFullYear()} Aravind Dakshan D.
        All rights reserved.
      </p>
