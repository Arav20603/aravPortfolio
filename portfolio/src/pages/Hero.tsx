  ...
  return (
    <div className="hero text-white poppins-regular mt-25 h-135 flex gap-10 justify-between">
      ...
      <div className="left ml-15 w-200 flex flex-col gap-4 border-indigo-800 border-l-4 h-120 justify-center px-5">
        <p className="mb-1 text-blue-200 text-sm ml-4 text-center">Hi, my name is</p>
        <h1 className="text-7xl ml-3 mb-1 font-semibold text-blue-600 text-center">Aravind Dakshan D.</h1>
        ...
        <p className="text-3xl mb-4 ml-2 text-blue-400 left-text4">MERN Stack Developer | React Native Enthusiast | Problem Solver</p>
        <p className="text-xl/8 ml-2 text-blue-200">Passionate about building web and mobile applications, 
